  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f0f4f0', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ backgroundColor: verde, color: 'white', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 12 }}>
        <button onClick={() => { const r = sessionStorage.getItem('profesor_rol_gestion'); window.location.href = (r === 'director' || r === 'secretario') ? '/gestion' : r === 'jefe_estudios' ? '/jefe-estudios' : '/profesor'; }} style={{ background: 'none', border: 'none', color: 'white', fontSize: 22, cursor: 'pointer' }}>←</button>
      ...
      <div style={{ padding: 16 }}>
        ...
        <ValoracionModulo modulo="compras" />
        {/* =================== FORMULARIO =================== */}
        {vista === 'formulario' && (
