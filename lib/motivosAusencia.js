...
export const AVISOS = {
  BAJA: {
    ...
    texto: 'Este motivo es para ausencias de más de un día. Supone una baja, y el funcionario de carrera está obligado a aportar el documento oficial de baja. Al guardarla se avisa a la dirección con los datos de abajo, para que valore la sustitución y lo tramite con Inspección Médica. No hace falta que escribas nada del diagnóstico.',
  },
  EXTRAESCOLAR: {
...
export const CAMPOS_EXTRA = {
  ...
  // Licencia por enfermedad: los datos que dirección necesita para
  // decidir si procede sustitución y para tramitarlo con Inspección.
  // No se pregunta el diagnóstico ni nada clínico: la aplicación no
  // guarda ni envía el motivo médico, solo lo administrativo.
  lic_enfermedad: {
    titulo: '🏥 Datos de la baja',
    campos: [
      { id: 'fecha_inicio_baja', label: 'Fecha de inicio de la baja', requerido: true, tipo: 'date',
        ayuda: 'La que figura en el parte oficial, aunque sea anterior a hoy.' },
      { id: 'duracion_probable', label: 'Duración probable (días)', requerido: true, tipo: 'number',
        ayuda: 'Una estimación basta. Si luego cambia, avisa a Secretaría.' },
      { id: 'sustitucion', label: '¿Ves recomendable pedir sustitución?', requerido: true, tipo: 'select',
        opciones: ['Sí, lo veo necesario', 'No hace falta', 'No sabría decir'],
        ayuda: 'Es tu parecer; la decisión la toma la dirección.' },
    ],
  },
};
