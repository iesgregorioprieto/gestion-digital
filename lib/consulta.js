...
class ConsultaBuilder {
  ...
  select(columns, opciones) {
    this._columns = columns;
    // .select('x', { count: 'exact' }) — se pide el total además de las filas
    if (opciones && opciones.count) this._contar = true;
    return this;
  }
  ...
  range(desde, hasta) { this._rango = [desde, hasta]; return this; }
  order(col, opts = {}) {
